...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tunnel.hostname'
        db.add_column(u'webvm_tunnel', 'hostname',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Tunnel.ip'
        db.alter_column(u'webvm_tunnel', 'ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True))

    def backwards(self, orm):
        # Deleting field 'Tunnel.hostname'
        db.delete_column(u'webvm_tunnel', 'hostname')


        # User chose to not deal with backwards NULL issues for 'Tunnel.ip'
        raise RuntimeError("Cannot reverse this migration. 'Tunnel.ip' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Tunnel.ip'
        db.alter_column(u'webvm_tunnel', 'ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))
    ...
    models = {
        ...
        u'webvm.virtualmachine': {
            ...
            'tunnel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webvm.Tunnel']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        }
    }
