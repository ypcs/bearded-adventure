...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webvm_jobqueueitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('vm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webvm.VirtualMachine'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('priority', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'webvm', ['JobQueueItem'])


    def backwards(self, orm):
        # Deleting model 'JobQueueItem'
        db.delete_table(u'webvm_jobqueueitem')
