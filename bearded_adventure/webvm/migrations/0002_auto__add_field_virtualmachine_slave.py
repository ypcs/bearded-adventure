...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualMachine.slave'
        db.add_column(u'webvm_virtualmachine', 'slave',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['webvm.Slave']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualMachine.slave'
        db.delete_column(u'webvm_virtualmachine', 'slave_id')
    ...
    models = {
        ...
        u'webvm.virtualmachine': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'slave': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webvm.Slave']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        }
    }
