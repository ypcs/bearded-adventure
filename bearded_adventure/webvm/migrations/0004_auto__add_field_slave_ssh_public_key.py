...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slave.ssh_public_key'
        db.add_column(u'webvm_slave', 'ssh_public_key',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slave.ssh_public_key'
        db.delete_column(u'webvm_slave', 'ssh_public_key')
