...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualMachine.tunnel'
        db.add_column(u'webvm_virtualmachine', 'tunnel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webvm.Tunnel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualMachine.tunnel'
        db.delete_column(u'webvm_virtualmachine', 'tunnel_id')
