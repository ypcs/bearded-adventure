...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VirtualMachine.slave'
        db.alter_column(u'webvm_virtualmachine', 'slave_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webvm.Slave'], null=True))

    def backwards(self, orm):

        # Changing field 'VirtualMachine.slave'
        db.alter_column(u'webvm_virtualmachine', 'slave_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['webvm.Slave']))
