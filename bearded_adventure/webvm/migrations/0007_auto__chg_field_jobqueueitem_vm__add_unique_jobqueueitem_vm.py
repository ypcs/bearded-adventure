...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobQueueItem.vm'
        db.alter_column(u'webvm_jobqueueitem', 'vm_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['webvm.VirtualMachine'], unique=True))
        # Adding unique constraint on 'JobQueueItem', fields ['vm']
        db.create_unique(u'webvm_jobqueueitem', ['vm_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'JobQueueItem', fields ['vm']
        db.delete_unique(u'webvm_jobqueueitem', ['vm_id'])


        # Changing field 'JobQueueItem.vm'
        db.alter_column(u'webvm_jobqueueitem', 'vm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webvm.VirtualMachine']))
